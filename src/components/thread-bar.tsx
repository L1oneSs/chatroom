...
export const ThreadBar = ({
    ...
    return (
        ...
        >
            <div className="flex items-center gap-2 owerflow-hidden">
            ...
            <ChevronRight className="size-4 text-muted-foreground ml-auto opacity-0 group-hover/thred-bar:opacity-100 transition shrink-0" />
        </button>
    )
}